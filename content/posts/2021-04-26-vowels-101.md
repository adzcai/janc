...
This determines whether or not **air passes through the nasal cavity** as well as through the mouth. For example, in French, nasalization is phonemic and marks the difference between "main" /mɛ̃/ (hand) or "mets" /mɛ/ (a dish in cooking or the third person singular conjugation of *mettre*, to place). A number of languages use phonemic nasalization, including many Aboriginal languages in the Americas as well as certain dialects of Mandarin.


### Voicing

Another distinction is **voicing,** which works exactly the same way as it does for consonants: essentially, a voiced vowel is one where your vocal chords can vibrating, and unvoiced is where they aren't.
